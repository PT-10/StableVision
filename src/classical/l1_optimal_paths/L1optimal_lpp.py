# File used from the following source:
# https://github.com/ishank-juneja/L1-optimal-paths-Stabilization/blob/master/L1optimal_lpp.py
# 
# Original Copyright (c) 2019 Ishank Juneja
